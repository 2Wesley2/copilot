...
export interface ProductMongoWritePersistence {
  readonly _id: Types.ObjectId;
  readonly attributes?: unknown;
  readonly createdAt: Date;
  readonly deletedAt?: Date | null;
...
@NestSchema({
  collection: MONGO_COLLECTION_NAMES.product,
  timestamps: true,
  versionKey: false,
})
export class ProductDefinition {
  ...
  public deletedById?: Types.ObjectId | null | undefined;
  ...
  @Prop({
    type: String,
    default: (): string => new Types.ObjectId().toHexString(),
    index: true,
  })
  ...
  public previousVersionId?: Types.ObjectId | null | undefined;
...
export type ProductMongoDocument = HydratedDocument<ProductDefinition>;
export const PRODUCT_MODEL_NAME = MONGO_MODEL_NAMES.product;
export const productSchema = SchemaFactory.createForClass(ProductDefinition);
